...
\begin{center}
\begin{tabularx}{\linewidth}{l>{\RaggedRight}p{5cm}>{\RaggedRight}X}
\toprule
...
\texttt{documentation\_only} & Paper, script without usable data & Query expansion, provenance discovery \\
